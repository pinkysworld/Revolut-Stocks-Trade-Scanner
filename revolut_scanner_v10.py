"""
Revolut Germany — Bullish Scanner v10
======================================
What's new versus v9
--------------------
Crypto universe
...
Run:      python revolut_scanner_v10.py
"""
...
def refresh_swing_prices(recs, sl_vol_frac=STOP_LOSS_VOL_FRAC,
    ...
    for r in recs:
        ...
        ov = overnight_cost(cls, notional, r["currency"], r.get("hold_calendar_days", HOLD_CALENDAR_DAYS))
        fees = of + cf + ov
...
def main():
    ...
    print("   recommendations.csv  stock_recommendations.csv  crypto_weekly_recommendations.csv")
    print("   daytrade_recommendations.csv  stock_daytrade_recommendations.csv  crypto_daytrade_recommendations.csv")
    print("   crypto_intraday_recommendations.csv")
    print()
